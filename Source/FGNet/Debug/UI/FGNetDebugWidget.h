...
public:
	...
	// Ratio of packets to randomly drop (0 = nope, 100 = all)
...
public:
	...
	UFUNCTION(BlueprintImplementableEvent, Category = Widget, meta = (DisplayName = "On Update Network Simulatioin Settings"))
